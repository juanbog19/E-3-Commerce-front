    ...
    <div>
      ...
      <div className="flex flex-wrap justify-around">
        ...
        {currentProduct.length <= 0 && (
          <div
            className="mt-4 flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:text-red-400 dark:border-red-800"
            role="alert"
          >
            <svg
            ...
            <div>
              <span className="font-medium">¡Oops!</span> No hay productos
              disponibles.
            </div>
          </div>
        )}
