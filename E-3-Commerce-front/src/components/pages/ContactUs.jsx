...
const AboutUs = () => {
    return (
        ...
        <div className="container flex flex-col items-center justify-center p-0 mx-auto sm:p-10">
          <p className="p-2 text-sm font-medium text black -center uppercase tracki">
            Development team
          </p>
          <h1 className="mt-5 mb-10 text-4xl font-bold text-center leadi sm:text-5xl">
  
            Te presentamos nuestro equipo de expertos:
  
          </h1>
          <div className="flex flex-row flex-wrap-reverse justify-center mt-8 bg-red ">
          ...
          <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
            ...
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
              <img
                alt="imagen"
                className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500"
                src="https://avatars.githubusercontent.com/u/99670063?v=4"
  
              />
              <div className="flex-1 my-4">
                <p className="text-xl font-semibold leadi">Xavier Montalvo</p>
                <p>Full Stack Developer</p>
              </div>
              <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                <a
            ...
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
              ...
              <div className="flex-1 my-4">
                <p className="text-xl font-semibold leadi">Emiliano Castro</p>
                <p>Full Stack Developer</p>
              </div>
              <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                <a
            ...
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
              <img
                alt="imagen"
                className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500"
                src="https://res.cloudinary.com/dm9glx5a7/image/upload/v1694111383/PF-HOTEL-APP/Perfiles/WhatsApp_Image_2023-09-07_at_13.50.04_cel5a2.jpg"
              />
              <div className="flex-1 my-4">
            ...
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
              <img
                alt="imagen"
                className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500"
                src="https://avatars.githubusercontent.com/u/32624310?s=48&v=4"
              />
              <div className="flex-1 my-4">
