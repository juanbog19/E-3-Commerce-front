const Footer = () => {
    return (
        <div>
<section>
    <div className="absolute inset-x-0 mx-auto space-y-8 overflow-hidden border-t-2 border-gray-200 sm:px-6">
        <div className="flex justify-center mt-8 space-x-6">
            <a href="#" className="text-[#374151] hover:text-purple-500">
