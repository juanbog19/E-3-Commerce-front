            ...
            <div className='flex justify-center '>
                <div className='w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8  dark:border-gray-300'>
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        ...
                        <button type='submit' className="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">Guardar Producto</button>
                    </form>
                </div>
            </div>
        </div>
