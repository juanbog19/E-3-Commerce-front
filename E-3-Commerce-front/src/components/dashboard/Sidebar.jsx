...
import { FaGlobe, FaUserAlt, FaWeightHanging, FaTag, FaBox, FaSignInAlt } from "react-icons/fa";
        ...
        <>
            <aside className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0">
                <div className="h-full px-3 py-4 overflow-y-auto bg-purple-600 ">
                    ...
                    <div>
                        <Link onClick={logout} to="/" className="flex items-center p-2 text-gray-300 rounded-lg hover:bg-purple-800 group">
                            <FaSignInAlt />
